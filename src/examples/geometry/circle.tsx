...
import createFeatureCircle from './utils/feature/createFeatureCircle';
...
const XYZ = (): JSX.Element => {
  ...
  useEffect(() => {
    ...
    if (mapRef.current) {
      ...
      const circleFeatures = lists.map(item => {
        const feature = createFeatureCircle(item, 300);
