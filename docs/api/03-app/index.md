...
[`Font`](https://docs.expo.dev/versions/latest/sdk/font/) | 字体 | - | `expo-font`

#### 视图

类 | 说明 | 兼容平台 | 来源
---|---|---|---
[`Dimensions`](https://reactnative.dev/docs/dimensions) | 尺寸 | - | `react-native`
...
[`SafeAreaView、SafeAreaProvider`](https://docs.expo.dev/versions/latest/sdk/safe-area-context/) | 安全区域上下文 | - | `react-native-safe-area-context`
...
类 | 说明 | 兼容平台 | 来源
---|---|---|---
[`getLocales、getCalendars`](https://docs.expo.dev/versions/latest/sdk/localization/) | 本地化 | - | `expo-localization`
...
类 | 说明 | 兼容平台 | 来源
---|---|---|---
[`Recording`、`Sound`](https://docs.expo.dev/versions/latest/sdk/audio-av/)、[`AV`、`Playback`](https://docs.expo.dev/versions/latest/sdk/av/)、[`Video`](https://docs.expo.dev/versions/latest/sdk/video-av/) | 音频和视频 | - | `expo-av`
[`AudioPlayer/AudioRecorder`](https://docs.expo.dev/versions/latest/sdk/audio/) | 音频 | - | `expo-audio`
[`VideoView`](https://docs.expo.dev/versions/latest/sdk/video/) | 视频 | - | `expo-video`
...
[`NavigationBar`](https://docs.expo.dev/versions/latest/sdk/navigation-bar/) | 导航栏 | Android | `expo-navigation-bar`
...
类 | 说明 | 兼容平台 | 来源
---|---|---|---
[`Location`](https://docs.expo.dev/versions/latest/sdk/location/) | 地理位置 | - | `expo-location`
...
类 | 说明 | 兼容平台 | 来源
---|---|---|---
[`EventEmitter`](https://docs.expo.dev/versions/latest/sdk/expo/)、`registerRootComponent()` | 应用&请求&事件 | - | `expo`
...
[`Asset`](https://docs.expo.dev/versions/latest/sdk/asset/) | 资产 | - | `expo-asset`
...
[`ExpoTrackingTransparency`](https://docs.expo.dev/versions/latest/sdk/tracking-transparency/) | 权限 | - | `expo-tracking-transparency`
[`Constants`](https://docs.expo.dev/versions/latest/sdk/constants/) | 常量 | - | `expo-constants`
[`Updates`](https://docs.expo.dev/versions/latest/sdk/updates/) | 自动更新 | - | `expo-updates`
...
[`Linking`](https://docs.expo.dev/versions/latest/sdk/linking/) | 链接 | - | `expo-linking`
...
[`ImageManipulator`](https://docs.expo.dev/versions/latest/sdk/imagemanipulator/) | 图像处理 | - | `expo-image-manipulator`
[`SystemUI`](https://docs.expo.dev/versions/latest/sdk/system-ui/) | 系统UI | - | `expo-system-ui`
[`Appearance`](https://reactnative.dev/docs/appearance) | 外观 | - | `react-native`
...
[`DynamicColorIOS`](https://reactnative.dev/docs/dynamiccolorios) | iOS 动态色彩 | iOS | `react-native`
...
[`ImagePicker`](https://docs.expo.dev/versions/latest/sdk/imagepicker/) | 图片选择器 | - | `expo-image-picker`
[`LivePhotoView`](https://docs.expo.dev/versions/latest/sdk/live-photo/) | 实时照片库 | iOS | `expo-live-photo`
[`MediaLibrary`](https://docs.expo.dev/versions/latest/sdk/media-library/) | 媒体库 | - | `expo-media-library`
[`CameraView`](https://docs.expo.dev/versions/latest/sdk/camera/) | 相机 | - | `expo-camera`
[`Contacts`](https://docs.expo.dev/versions/latest/sdk/contacts/) | 通讯录 | - | `expo-contacts`
[`Calendar`](https://docs.expo.dev/versions/latest/sdk/calendar/) | 日历 | - | `expo-calendar`
[`AppleMaps、GoogleMaps`](https://docs.expo.dev/versions/latest/sdk/maps/) | 地图 | - | `expo-maps`
...
[`ScreenCapture`](https://docs.expo.dev/versions/latest/sdk/screen-capture/) | 屏幕截图 | - | `expo-screen-capture`
[`ScreenOrientation`](https://docs.expo.dev/versions/latest/sdk/screen-orientation/) | 屏幕方向 | - | `expo-screen-orientation`
[`PermissionResponse`](https://docs.expo.dev/versions/latest/sdk/brightness/) | 屏幕亮度 | - | `expo-brightness`
[`KeepAwake`](https://docs.expo.dev/versions/latest/sdk/keep-awake/) | 休眠模式 | - | `expo-keep-awake`
...
[`Battery`](https://docs.expo.dev/versions/latest/sdk/battery/) | 电池 | - | `expo-battery`
[`NetInfo`](https://docs.expo.dev/versions/latest/sdk/netinfo/) | 网络信息（Wi-Fi） | - | `@react-native-community/netinfo`
[`Cellular`](https://docs.expo.dev/versions/latest/sdk/cellular/) | 移动网络 | - | `expo-cellular`
[`Network`](https://docs.expo.dev/versions/latest/sdk/network/) | 设备网络（IP、MAC、飞行模式） | - | `expo-network`
